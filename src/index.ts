...
export class SecureApplicationLoadBalancerAccessLogBucket extends SecureBucket {
  ...
  constructor(scope: Construct, id: string, props: SecureApplicationLoadBalancerAccessLogBucketProps) {
    ...
    const albRegionAccount: string = this.getApplicationLoadBalancerAccount(props.region);
    ...
    this.addToResourcePolicy(new iam.PolicyStatement({
      ...
      principals: [
        new iam.AccountPrincipal(albRegionAccount),
      ],
  ...
  private getApplicationLoadBalancerAccount(region: string): string {
